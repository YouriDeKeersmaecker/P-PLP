...
packageVersion("PatientLevelPrediction")
...
DatabaseConnector::querySql(conn, "SELECT COUNT(*) FROM public.person;")
DatabaseConnector::querySql(conn, "SELECT COUNT(*) FROM public.target_cohort;")

DatabaseConnector::disconnect(conn)


cdmDatabaseName <- 'synpuf100kaws'
...
savePlpData(plpData, "D:/School/BachelorProef/P-PLP/Benchmarking-Analysis-of-PLP-vs-MLR3/savePlpData")
plpData <- loadPlpData("D:/School/BachelorProef/P-PLP/Benchmarking-Analysis-of-PLP-vs-MLR3/savePlpData")
...
path = file.path("D:/School/BachelorProef/P-PLP/Benchmarking-Analysis-of-PLP-vs-MLR3/plpResults", "plpMlResults")
...
str(plpResult_lrLogiReg, max.level = 1)

# model outcome 
plpResult_lrLogiReg <- loadPlpResult(file.path("D:/School/BachelorProef/P-PLP/Benchmarking-Analysis-of-PLP-vs-MLR3/plpResults/plpMlResults/lrLogiReg/plpResult/"))
viewPlp(plpResult_lrLogiReg)

plpResult_lrForest <- loadPlpResult(file.path("D:/School/BachelorProef/P-PLP/Benchmarking-Analysis-of-PLP-vs-MLR3/plpResults/plpMlResults/lrForest/plpResult/"))
viewPlp(plpResult_lrForest)

plpResult_lrGradient <- loadPlpResult(file.path("D:/School/BachelorProef/P-PLP/Benchmarking-Analysis-of-PLP-vs-MLR3/plpResults/plpMlResults/lrGradient/plpResult/"))
viewPlp(plpResult_lrGradient)

library(pROC)

pred <- plpResult_lrLogiReg$prediction
roc_obj <- roc(pred$outcome, pred$value)
...
plpResult_lrForest <- loadPlpResult(file.path("D:/School/BachelorProef/P-PLP/Benchmarking-Analysis-of-PLP-vs-MLR3/plpResults/plpMlResults/lrForest_oversample/plpResult/"))
viewPlp(plpResult_lrForest)
...
#save.image(file = "PLP-pipeline.RData")
